...
public class LoginRequestValidatorTests
{
    ...
    public void Validate_WhenInputIsValid_Passes(string username, string password)
    {
        ...
        var validator = new LoginRequestValidator(options);

        var result = validator.Validate(new LoginRequest(username, password));
    ...
    public void Validate_WhenUsernameIsMissing_Fails(string username)
    {
        ...
        var result = validator.Validate(new LoginRequest(username, "abcdef"));
    ...
    public void Validate_WhenPasswordTooShort_Fails(string password)
    {
        ...
        var result = validator.Validate(new LoginRequest("user", password));
    ...
    public void Validate_WhenUppercaseRequiredAndMissing_Fails()
    {
        ...
        var result = validator.Validate(new LoginRequest("user", "abcdef"));
    ...
    public void Validate_WhenSpecialRequiredAndMissing_Fails()
    {
        ...
        var result = validator.Validate(new LoginRequest("user", "Abcdef1"));
